...
contract Gacha is VRFConsumerBase, Ownable {
    ...
    constructor(
        ...
        address _linkToken,
        uint256 _fee,
        uint256[] memory arrayOfItemDropChance,
        uint256[] memory arr_ID,
    ...
    function setGachaItemProperties(
        uint256[] memory arrayOfItemDropChance,
        uint256[] memory arr_ID,
        address OwnerContract,
        address NFT_address,
    ...
    function sample(uint256[] memory arr, uint256 randomness)
        public
    ...
    function GachaRandomCaller() public returns (bytes32 requestId) {
        ...
        require(
            acmNFT.isApprovedForAll(msg.sender, address(this)),
            "contract must approve"
        );
        require(
    ...
    function openGacha() public {
        ...
        require(
            s_results[msg.sender] != ROLL_IN_PROGRESS,
            "Calling for random number please wait"
        );
